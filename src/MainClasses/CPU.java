...
public class CPU extends Thread {
    ...
    public void run() { //Aquí también hay que llevar el contadodor de ciclos global
        ...
        Proceso p = null;
        System.out.println("COLA DE LISTOS EN CPU");
        System.out.println(app.getPlanificador().travelName());
        while (true) {
            if (p != null) {
                p.setTiempoEnCola(p.getTiempoEnCola() + (app.relojGlobal - p.getCicloEntradaListo()));
